...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.load_classes_error.sizePolicy().hasHeightForWidth())
        self.load_classes_error.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial Narrow")
        font.setPointSize(10)
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
        self.load_classes_error.setFont(font)
        self.load_classes_error.setStyleSheet("QLabel {\n"
"    color: #BA181B;\n"
"}")
        self.load_classes_error.setAlignment(QtCore.Qt.AlignCenter)
        self.load_classes_error.setObjectName("load_classes_error")
    ...
    def retranslateUi(self, NN2GUI):
        ...
        self.load_classes_error.setText(_translate("NN2GUI", "Error"))
